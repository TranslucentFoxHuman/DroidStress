...
- **A better app icon**  
  The icon must be GPL‑compatible, editable in Inkscape as an SVG file. Please do not use AI to create it - I can give the AI instructions to generate that myself.
